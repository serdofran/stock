...
<div class="modal fade" id="addProductModal" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
    	...
    	<form class="form-horizontal"  action="php_action/createProduct.php" method="POST" enctype="multipart/form-data">
	        ...
	        <div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
					  ...
					  try{
						  $stm =$pdo->prepare("SELECT brand_id , brand_name , brand_active , brand_status FROM brands WHERE brand_active=? AND brand_status=?");
						  ...
						  $stm->execute([1,1]);
							...
							while($row = $stm->fetch(\PDO::FETCH_ASSOC)) {
							  ...
							  // echo $row['brand_id']; echo $row['brand_name'];
	        ...
	        <div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
					  ...
					  try{
						  $stm =$pdo->prepare("SELECT categories_id , categories_name , categories_active , categories_status FROM categories WHERE categories_active=? AND categories_status=?");
